...
2. **Naming:** You **must** name it ic\_stat\_versicle.png.  
    ...
    private async engageBackgroundMode(item: TTSQueueItem) {  
        ...
        try {  
            ...
            await ForegroundService.startForegroundService({  
                ...
                smallIcon: 'ic\_stat\_versicle', // This MUST match the drawable resource name  
                notificationChannelId: 'versicle\_tts\_channel',  
                buttons: \[   
...
7. **Troubleshooting:**  
   * *Crash on Start:* Check ic\_stat\_versicle exists.  
