    ...
    <SheetContent side="right" className="w-full sm:w-[400px] flex flex-col p-0 gap-0" data-testid="tts-panel">
       ...
       <div className="player-stage bg-muted/30 p-4 border-b">
          ...
          <div className="flex justify-center items-center gap-6 mb-4">
             <Button variant="ghost" size="icon" onClick={() => seek(-15)} aria-label={providerId === 'local' ? "Previous Sentence" : "Rewind 15s"}>
             ...
             <Button variant="ghost" size="icon" onClick={() => seek(15)} aria-label={providerId === 'local' ? "Next Sentence" : "Forward 15s"}>
