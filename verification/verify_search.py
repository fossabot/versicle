...
def verify_library_search():
    with sync_playwright() as p:
        ...
        # Use mobile viewport to verify the layout responsiveness/visibility
        ...
        try:
            ...
            # In mobile view, empty library might look different? Assuming "Load Demo Book" is still visible or accessible.
            # The EmptyLibrary component likely renders the button.
            ...
            # Take a screenshot of library with book (Mobile Layout)
            page.screenshot(path="verification/mobile_library_with_book.png")

            # Search for non-existent book
            print("Searching for non-existent book...")
            search_input = page.get_by_placeholder("Search") # Updated placeholder
            ...
            page.screenshot(path="verification/mobile_search_no_results.png")
            print("Screenshot saved to verification/mobile_search_no_results.png")
            ...
            # Verify "Sort by" text is present
            expect(page.get_by_text("Sort by: Recently Added")).to_be_visible()

            # Take a screenshot of search results (found)
            page.screenshot(path="verification/mobile_search_results.png")
            print("Screenshot saved to verification/mobile_search_results.png")

        except Exception as e:
            print(f"Error: {e}")
            page.screenshot(path="verification/error.png")
            raise e # Raise to ensure failure is reported
        finally:
            browser.close()
